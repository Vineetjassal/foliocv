  ...
  head: () => ({
    meta: [
      ...
      { title: "FolioCV — Resume to portfolio in seconds" },
      {
        name: "description",
        content:
          "Upload your CV and GitHub. Get a beautiful, editable portfolio site you can download as code. No signup.",
      },
      { property: "og:title", content: "FolioCV" },
      {
        property: "og:description",
        content: "Resume + GitHub → minimal portfolio site, yours to download.",
      },
