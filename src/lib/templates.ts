...
border-radius:50%;border:1.5px solid var(--teal);cursor:pointer;font-size:.85rem;
display:flex;align-items:center;justify-content:center;
background:var(--bg,#fff);color:var(--teal);
box-shadow:0 2px 12px rgba(13,148,136,.18);transition:all .25s;font-family:inherit;"></button>
<script>(function(){
...
/* ── Light ── */
[data-theme="light"]{
  --bg:#ffffff;--bg2:#f0fdfa;--bg3:#e6fffa;
  --text-primary:#0f172a;--text-secondary:#1e293b;--text-muted:#475569;--text-faint:#94a3b8;
  --line:rgba(13,148,136,.22);--line2:rgba(13,148,136,.35);--label:#64748b;
  --card-bg:#ffffff;--card-border:rgba(13,148,136,.4);--card-shadow:rgba(13,148,136,.10);
  --badge-bg:#f0fdfa;--badge-border:rgba(13,148,136,.45);--badge-color:#0f766e;
  --nav-bg:#ffffff;
}
/* ── Dark ── */
[data-theme="dark"]{
  --bg:#0a1a1a;--bg2:#0d2222;--bg3:#0f2e2e;
  --text-primary:#e2faf8;--text-secondary:#a7f3d0;--text-muted:#6ee7b7;--text-faint:#2dd4bf;
  --line:rgba(13,148,136,.28);--line2:rgba(13,148,136,.45);--label:#5eead4;
  --card-bg:#0d2222;--card-border:rgba(13,148,136,.5);--card-shadow:rgba(0,0,0,.4);
  --badge-bg:#0f2e2e;--badge-border:rgba(13,148,136,.45);--badge-color:#5eead4;
  --nav-bg:#0a1a1a;
}
...
.fc-nav a:hover{opacity:.7;text-decoration:none;}
.fc-nav-brand{font-weight:700;font-size:.92rem;color:var(--teal);margin-right:auto;}
...
.pcard-lang{font-size:.68rem;color:var(--teal);font-family:monospace;margin-bottom:.35rem}
.pcard-links{display:flex;gap:.75rem;font-size:.75rem;}
.pcard-links a{color:var(--teal);}
...
.exp-co,.edu-school{font-size:.8rem;color:var(--teal);}
...
.gl-arrow{position:absolute;top:50%;transform:translateY(-50%);background:var(--teal);color:#fff;border:none;width:2rem;height:2rem;font-size:1.2rem;cursor:pointer;z-index:2;display:flex;align-items:center;justify-content:center;transition:opacity .2s;opacity:.8;border-radius:50%;}
...
.gl-dot.active{width:1rem;background:var(--teal);border-radius:.2rem;}
`;
...
.ink-drop-cap::first-letter{float:left;font-size:4.2em;line-height:.75;margin:.06em .1em 0 0;font-weight:900;color:var(--teal);}
...
.ink-aside-links a{font-size:.75rem;color:var(--teal);border-bottom:1px solid var(--line);padding:.2rem 0;}
...
.sh-links a{font-size:.75rem;color:var(--teal);display:flex;align-items:center;gap:.4rem;}
.sh-links a::before{content:'→';font-size:.7rem;color:var(--teal-mid);}
...
.mo-av{width:80px;height:80px;border-radius:50%;object-fit:cover;margin:0 auto 1.25rem;border:2px solid var(--teal);}
.mo-name{font-family:'IBM Plex Mono',monospace;font-size:clamp(1.8rem,6vw,3rem);font-weight:700;letter-spacing:-.04em;line-height:1.1;margin-bottom:.3rem;color:var(--teal);}
...
.mo-links a{font-size:.75rem;color:var(--teal);border-bottom:1px solid var(--line);padding-bottom:1px;transition:border-color .2s;}
.mo-links a:hover{border-color:var(--teal);text-decoration:none;}
...
.mo-timeline{border-left:2px solid var(--teal);padding-left:1.25rem;}
.mo-timeline .exp{position:relative;}
.mo-timeline .exp::before{content:'';position:absolute;left:-1.43rem;top:.55rem;width:.6rem;height:.6rem;border-radius:50%;background:var(--teal);border:2px solid var(--bg);}
...
.rl-row-links a{font-size:.72rem;color:var(--teal);}
